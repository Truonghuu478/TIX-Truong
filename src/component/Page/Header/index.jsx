...
function Header(props) {
  ...
  return (
    <Fragment>
      ...
      <Box
        style={{ width: dropdown ? "70%" : 0, padding: dropdown ? "15px" : 0 }}
      ...
      <Box
        onClick={() => setDropdown(!dropdown)}
        style={{
          backgroundColor: dropdown ? "rgba(0,0,0,.8)" : "transparent",
          pointerEvents: dropdown ? "inherit" : "none",
        }}
        className="side-menu"
      ></Box>
    </Fragment>
