          ...
          <div className="container adsNews">
            <ul className="nav nav-pills">
              <li className="nav-item">
                <a className="nav-link active" data-toggle="pill" href="#cinemaE" >Điện ảnh 24h</a>
              </li>
              <li className="nav-item">
                <a className="nav-link" data-toggle="pill" href="#cinemaR" >Review</a>
              </li>
              <li className="nav-item">
                <a className="nav-link" data-toggle="pill" href="#cinemaO" >Khuyến mãi</a>
              </li>
            </ul>
            {/* Tab panes */}
                ...
                <div style={{margin:"0 15px 0 15px "}} className="row">
                  <div className="col-md-6 col-12 abv">
                    <div className="abv_item1">
                      <div className="image">
                        <img src="./img/news/image1.png" alt="new-1" className="img-fluid" />
                      </div>
                  ...
                  <div className="col-md-6 col-12 abv">
                    <div className="abv_item1">
                      <div className="image">
                        <img src="./img/news/image2.png" alt="new-1" className="img-fluid" />
                      </div>
                      <div className="content">
                        <a href="#" className="title">
                        ...
                        <p className="sub_title">
                        Nhân dịp tác phẩm “Kẻ Xâm Nhập” giữ vững ngôi vương phòng vé suốt gần một tuần trình chiếu tại quê nhà, ekip sản xuất liền cho đăng tải poster cùng trailer đặc biệt, đồng thời chia sẻ không ít thông tin lý thú xoay quanh nội dung bộ 
                        </p>
                      </div>
                      <div className="statusBar">
                        <div className="d-flex align-items-center">
                  ...
                  <div className="col-md-4 col-12 abv ">
                    <div className="abv_item1">
                      <div className="image">
                        <img src="./img/news/image3.png" alt="img-3" className="img-fluid" />
                      </div>
                      <div className="content">
                        <a href="#" className="title">
                  ...
                  <div className="col-md-4 col-12 abv ">
                    <div className="abv_item1">
                      <div className="image">
                        <img src="./img/news/image4.png" alt="new-4" className="img-fluid" />
                      </div>
                      <div className="content">
                        <a href="#" className="title">
                  ...
                  <div className="col-md-4 col-12 abv ">
                    <div className="abv_item2">
                      <div className="d-flex pt-0">
                        <img src="./img/news/image5.png" alt="new-5" className="img-fluid" />
                        <p>6 đạo diễn tỉ đô làm nên thành công của những bom... tấn đình đám nhất Hollywood</p>
                      </div>
                      <div className="d-flex">
                        <img src="./img/news/image6.png" alt="new-6" className="img-fluid" />
                        <p>Gái Già Lắm Chiêu V – Những cuộc đời vương giả</p>
                      </div>
                      <div className="d-flex">
                        <img src="./img/news/image7.png" alt="abv_new3" className="img-fluid" />
                        <p>Kaity Nguyễn trở thành mỹ nhân mới của vũ trụ Gái Già Lắm Chiêu</p>
                      </div>
                      <div className="d-flex">
                        <img src="./img/news/image8.png" alt="abv_new4" className="img-fluid" />
                        <p>5 lý do khiến bạn không thể bỏ qua bộ phim Cậu Bé Người Gỗ Pinocchio</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="tab-pane pane__1 fade" id="cinemaR">
                <div className="row">
                  <div className="col-md-6 col-12 abv">
                    <div className="abv_item1">
                      <div className="image">
                        <img src="./img/news/rw1.png" alt="abv_7" className="img-fluid" />
                      </div>
                      <div className="content">
                        <a href="#" className="title">
                        ...
                        <p className="sub_title">
                        Điểm nhấn của phim kinh dị năm 2020 chính là Tàn Tích Quỷ Ám  </p>
                      </div>
                      <div className="statusBar">
                        <div className="d-flex align-items-center">
                          <i className="far fa-thumbs-up" />
                  ...
                  <div className="col-md-6 col-12 abv">
                    <div className="abv_item1">
                      <div className="image">
                        <img src="./img/news/rw2.png" alt="abv_5" className="img-fluid" />
                      </div>
                      <div className="content">
                        <a href="#" className="title">
                  ...
                  <div className="col-md-4 col-12 abv ">
                    <div className="abv_item1">
                      <div className="image">
                        <img src="./img/news/rw3.png" alt="abv_6" className="img-fluid" />
                      </div>
                      <div className="content">
                        <a href="#" className="title">
                  ...
                  <div className="col-md-4 col-12 abv ">
                    <div className="abv_item1">
                      <div className="image">
                        <img src="./img/news/rw4.png" alt="abv_4" className="img-fluid" />
                      </div>
                      <div className="content">
                        <a href="#" className="title">
                  ...
                  <div className="col-md-4 col-12 abv ">
                    <div className="abv_item2">
                      <div className="d-flex pt-0">
                        <img src="./img/news/rw5.png" alt="abv_new5" className="img-fluid" />
                        <p>Review: Spider-Man: Into The Spider-Vesre  </p>
                      </div>
                      <div className="d-flex">
                        <img src="./img/news/rw6.png" alt="abv_new6" className="img-fluid" />
                        <p>COVID-19 là bản chính thức của MEV-1 phim contagion (2011)</p>
                      </div>
                      <div className="d-flex">
                        <img src="./img/news/rw7.png" alt="abv_new7" className="img-fluid" />
                        <p>[Review] Siêu Vệ Sĩ Sợ Vợ - Giải cứu Tổng thống chưa bao giờ lầy lội và hài hước
                          đến thế</p>
                      </div>
                      <div className="d-flex">
                        <img src="./img/news/rw8.png" alt="abv_new8" className="img-fluid" />
              ...
              <div className="tab-pane pane__1 fade" id="cinemaO">
                <div className="row">
                  <div className="col-md-6 col-12 abv">
                    <div className="abv_item1">
                      <div className="image">
                        <img src="./img/news/voucher1.jpg" alt="abv_8" className="img-fluid" />
                      </div>
                      <div className="content">
                        <a href="#" className="title">
                  ...
                  <div className="col-md-6 col-12 abv">
                    <div className="abv_item1">
                      <div className="image">
                        <img src="./img/news/voucher2.jpg" alt="abv_9" className="img-fluid" />
                      </div>
                      <div className="content">
                        <a href="#" className="title">
                  ...
                  <div className="col-md-4 col-12 abv ">
                    <div className="abv_item1">
                      <div className="image">
                        <img src="./img/news/voucher3.jpg" alt="abv_10" className="img-fluid" />
                      </div>
                      <div className="content">
                        <a href="#" className="title">
                        [123Phim] Thứ 6 Không Đen Tối -  Ưu đãi huỷ diệt 11k/vé Anh Trai Yêu Quái                        </a>
                        <p className="sub_title">
                  ...
                  <div className="col-md-4 col-12 abv ">
                    <div className="abv_item1">
                      <div className="image">
                        <img src="./img/news/voucher4.jpg" alt="abv_11" className="img-fluid" />
                      </div>
                      <div className="content">
                        <a href="#" className="title">
                  ...
                  <div className="col-md-4 col-12 abv ">
                    <div className="abv_item2">
                      <div className="d-flex pt-0">
                        <img src="./img/news/voucher5.jpg" alt="abv_new9" className="img-fluid" />
                        <p>[Mega GS] Một đoá hoa thay ngàn lời yêu</p>
                      </div>
                      <div className="d-flex">
                        <img src="./img/news/voucher6.jpg" alt="abv_new10" className="img-fluid" />
                        <p>[123Phim] NHẬP MÃ 'BKT' - Giảm ngay 20k khi đặt vé Bắc Kim Thang
                        </p>
                      </div>
                      <div className="d-flex">
                        <img src="./img/news/voucher7.jpg" alt="abv_new11" className="img-fluid" />
                        <p>Sinh Nhật Mega GS</p>
                      </div>
                      <div className="d-flex">
                        <img src="./img/news/voucher8.jpg" alt="abv_new12" className="img-fluid" />
            ...
            <div className="d-flex justify-content-center">
              <button className="btn btn-light" id="btn-more" >Xem thêm</button>
            </div>
          </div>
        </section>
