          ...
          <CardHeader
            avatar={
              <img
                ...
                alt={newTenCumRap.name}
                src={nameTheater.logo}
              />
            }
            title={`${newTenCumRap.name}- ${
        ...
        <Grid item lg={12} md={12} sm={12}>
          <Link
            style={{
              ...
              top: screenWidth > 768 ? 30 : null,
              left: screenWidth > 768 ? 30 : 0,
              bottom: screenWidth < 768 ? 0 : null,
              width: screenWidth < 768 ? "50%" : null,
              background:
                screenWidth < 768
                  ? "linear-gradient(223deg, rgb(133 136 127) 0px, rgb(59 61 58) 100%)"
                  : null,
              height: screenWidth < 768 ? "100px" : null,
              color: screenWidth < 768 ? "#fff" : null,
              lineHeight: screenWidth < 768 ? "100px" : null,
              fontSize: screenWidth < 768 ? 13 : null,
              textAlign: screenWidth < 768 ? "center" : null,
            }}
