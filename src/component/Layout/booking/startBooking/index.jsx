...
function StartBooking(props) {
  ...
  const __renderChoose = (nameVe, toTal, sttChair) => {
    ...
    return (
      <>
        ...
        <div className="theaterChoose__change">
          <i
            style={{
              color: sttChair === 0 ? "gray" : "red",
              cursor: sttChair === 0 ? null : "pointer",
            }}
            onClick={() => {
          ...
          <i
            style={{
              color: sttChair >= 12 ? "gray" : "red",
              cursor: sttChair >= 12 ? null : "pointer",
            }}
            onClick={() => {
    ...
    return (
      <>
        ...
        <button
          ...
          className={
            valid
              ? classes.notDisabled + " theaterTotal__last"
  ...
  return (
    <div className="startBooking">
      <div className="startBooking__content">
        {screenWidth > 768 && (
          <div className="theaterInfo">{__renderTheater()}</div>
        )}
        ...
        <div className="theaterTotal">{__renderTotal()}</div>
        <span className="theater__danger">
          Xin lưu ý, bạn không thể hủy hoặc thay đổi suất chiếu cho vé đã mua.
        </span>
        <div className="theater__call">
          <div className="theater__call--hotline">
            <p>HOTLINE</p>
