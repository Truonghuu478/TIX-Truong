...
function BackHome(props) {
        ...
        if (props.listTicketRoom) {
            ...
            return <>
                <div className="backHome__bg">
                    <img src={thongTinPhim.hinhAnh} alt={`phim - ${thongTinPhim.tenPhim}`} />
                </div>
                <div className="over-dark"></div>
                <Link onClick={props.handleRestart} 
                style={{opacity:props.step !== 1?0:1}} to="">
                ...
                <div style={{opacity:props.step !== 1?0:1}} className="backHome__detail">
                    <p>Hôm nay</p>
    ...
    return (
        ...
        <div style={{padding:props.step !== 1 ? "0 -15px":" 0"}} className={props.step !==1 ?"  col-lg-1 col-xl-1 col-md-1 ":"col-lg-4 col-xl-3 col-md-3"}>
        <div style={{width:props.step === 2?"40px":"100%"}} className={" backHome"}>
            {__renderHTML()}
        </div>
        </div>
