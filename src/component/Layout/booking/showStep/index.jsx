...
function ShowTicket(props) {
    ...
    return arrStep.map((item, index) => {
        ...
        return (
          <div
            ...
            style={{
              cursor: null,
              fontWeight: 500,
              width: screenWidth < 768 ? "100%" : null,
            }}
      ...
      return (
        <div
          key={index}
          style={{
            cursor: step > index + 1 && step !== 3 ? "pointer" : null,
            fontWeight: 500,
            width: screenWidth < 768 ? "100%" : null,
          }}
          onClick={
            step > index + 1 && step !== 3
              ? () => {
                  changeStep(index, "restart__listChair");
                }
              : null
          }
        >
  ...
  }, [changeStep, classes.step, screenWidth, step]);
  ...
  return (
    <div style={{ width: step === 2 ? "77%" : null }} className="showStep row">
      <div
        className={
          step === 2
            ? "col-xs-12 col-md-9 col-xl-9 col-lg-10"
            : "col-xs-12 col-md-9 col-xl-10 col-lg-10"
        }
      >
        <div className="showStep__content">{__renderStep()}</div>
      </div>
      {screenWidth > 768 && (
        <div className="col-xs-0 col-md-3 col-xl-2 col-lg-2">
          <div
            style={{
              justifyContent: step !== 1 && step !== 3 ? "end" : "flex-end",
            }}
            className="user"
          >
