...
function Registers(props) {
  ...
  return (
    <div
      style={{
        width: screenWidth < 813 ? (screenWidth < 445 ? "100%" : "90%") : 800,
      }}
      className={`${classes.content} Login__background`}
    >
      <div
        onClick={__handleHistory}
        className={`${classes.close} Login__close`}
      >
        <CloseIcon />
      </div>
      ...
      >
        <div className={`${classes.modalBody} form__body`}>
          ...
          <ThemeProvider theme={theme}>
            <Box
              style={{ marginBottom: screenWidth < 813 ? 0 : "2rem" }}
              className={`${classes.BoxInput} form__body--BoxInput`}
              component="div"
            >
              <ValidationTextField
                style={{
                  marginBottom: screenWidth < 813 ? 30 : 10,
                  width: screenWidth < 812 ? "98%" : "48%",
                  padding: screenWidth < 813 ? 0 : 10,
                }}
            ...
            >
              ...
              <Box
                ...
                style={{
                  display: "flex",
                  justifyContent: "space-between",
                  width: screenWidth < 813 ? "98%" : "48%",
                  padding: screenWidth < 813 ? 0 : 10,
                  marginBottom: screenWidth < 813 ? 0 : 20,
                }}
                className={classes.input}
              >
        ...
        <div
          style={{ width: "100%", margin: screenWidth < 813 ? " 0 auto" : 0 }}
