...
export default function DetailUser() {
  ...
  const handleChangeMK = (e) => {
    ...
    let error  = {...mk.error,[name]: validate(name,value) ? validate(name,value,4,30) :""}
    let isValid = true;
  ...
  //   let { name, value } = e.target;
  //    setUser({ ...mk, [name]: validate(name,value) ? validate(name,value,4,30) :"" });
  // };
        ...
        <>
          ...
          <div className={classes("detail-user")}>
            <div className="detail-user--Out">
              <span>{userLogin.hoTen}</span>  <Link to="/" 
            ...
            <div className="detail-user__content">
              <Grid container spacing={6}>
               ...
               <div className="item__form ">
                    ...
                    {/* mk  */}
                    <div className="item__form " style={{gridRow:"3 / span 2"}}>
                      {/* <TextField
...
// accessToken: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJodHRwOi8vc2NoZW1hcy54bWxzb2FwLm9yZy93cy8yMDA1LzA1L2lkZW50aXR5L2NsYWltcy9uYW1lIjoibGV0cnVvbmciLCJodHRwOi8vc2NoZW1hcy5taWNyb3NvZnQuY29tL3dzLzIwMDgvMDYvaWRlbnRpdHkvY2xhaW1zL3JvbGUiOiJLaGFjaEhhbmciLCJuYmYiOjE2MDM3Mjc5NzEsImV4cCI6MTYwMzczMTU3MX0.UTJaoaiHN5-kfLsU9sB8FJ_KCz4UjSzif6uTiDAesqw"
// email: "truongkt@gmail.com"
// hoTen: "le huu truong"
